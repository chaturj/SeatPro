...
public class JustBridge: NSObject {
    ...
    @MainActor public func call(_ name: String, data: BridgeData, callback: Callback? = nil, errorCallback: ErrorCallback? = nil) {
...
extension JustBridge {
    ...
    @MainActor fileprivate func injectBridgeJS() {
        let script = WKUserScript(source: JustBridge.bridge_js, injectionTime: .atDocumentStart, forMainFrameOnly: true)
        print(script.description)
        self.webview!.configuration.userContentController.addUserScript(script)
    }

    @MainActor fileprivate func postMessage(_ name: String, data: BridgeData, swiftCallbackId: String? = nil, jsCallbackId: String? = nil, error: String? = nil) {
